...
def merge_units_across_ss():
    """
    Merge units across ecephys spike sortings.

    Only works across ecephys spike sortings of the same dataset.

    Requires to manually provide pairs of units from the 1st and second ecephys spike sorting.
    """
    return
