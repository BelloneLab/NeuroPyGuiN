...
def classify_noise_templates(args):
    ...
    use_random_forest = bool(args['noise_waveform_params']['use_random_forest'])
    if use_random_forest:
        try:
            ...
            print(
                "Random-forest noise classifier unavailable or incompatible with the current "
                f"scikit-learn runtime ({exc}). Falling back to heuristic noise-template checks."
            )
