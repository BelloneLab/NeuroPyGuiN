...
CITATIONS = {
    ...
    "hill2011": {
        ...
        "full": (
            ...
            "to accompany ecephys spike sorting of extracellular signals. Journal of "
            "Neuroscience, 31(24), 8699-8705."
        ),
        "bibtex": (
            "@article{hill2011quality,\n"
            "  author = {Hill, Daniel N. and Mehta, Samar B. and Kleinfeld, David},\n"
            "  title = {Quality metrics to accompany ecephys spike sorting of extracellular signals},\n"
...
def _intro_section(param, tracker):
    ...
    return (
        f"Automated ecephys spike sorting quality control was performed using "
