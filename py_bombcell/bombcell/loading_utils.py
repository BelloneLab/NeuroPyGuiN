...
def load_ephys_data(ephys_path):
    """
    This function loads the necessary data from the ecephys spike sorting to run BombCell
...
def get_gain_spikeglx(meta_path):
    ...
    scaling_factor : float
        The scaling factor to convert from int16 to microvolts (ÂµV/bit)
    ...
    Vmax_uV = float(meta_dict["imAiRangeMax"]) * 1e6  # Convert V to ÂµV
